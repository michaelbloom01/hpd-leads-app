 ...
 * Clean, modern design matching the HPD Leads brand.
 */
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900 tracking-tight">HPD Leads</h1>
          <p className="text-sm text-gray-500 mt-1">Elite Housing Intelligence Platform</p>
        </div>
