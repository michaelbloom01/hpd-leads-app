            ...
            contacts.append(
                {
                    ...
                    "publication_date": _coerce_iso(payload.get("source_published_at")),
                    "source_observed_at": _coerce_iso(payload.get("source_observed_at")) or last_refreshed_at,
                    "source_role_effective_at": payload.get("source_role_effective_at"),
                    "board_role_status": payload.get("board_role_status", "unverified"),
